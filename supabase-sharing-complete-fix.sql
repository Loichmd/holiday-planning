-- ============================================
-- COMPLETE FIX: Résolution totale de la récursion
-- ============================================
-- Ce script corrige TOUTES les policies qui causent une récursion infinie
-- y compris celles de la table projects

-- ============================================
-- 1. SUPPRIMER TOUTES LES POLICIES PROBLÉMATIQUES
-- ============================================

-- Policies de project_shares
...
-- Policies de projects (qui causent aussi la récursion)
DROP POLICY IF EXISTS "Users can view their own projects or shared projects" ON projects;
DROP POLICY IF EXISTS "Users can view their own projects" ON projects;

-- ============================================
-- 2. RECRÉER LA POLICY DE LECTURE POUR PROJECTS
-- ============================================

-- Policy simple : voir seulement mes propres projets
-- Les projets partagés seront chargés via une fonction SQL
CREATE POLICY "Users can view their own projects"
ON projects
FOR SELECT
USING (user_id = auth.uid());

-- Les autres policies de projects restent inchangées
-- (INSERT, UPDATE, DELETE ne causent pas de récursion)

-- ============================================
-- 3. RECRÉER LES POLICIES DE project_shares
-- ============================================

-- Policy SELECT : Voir les partages de mes projets OU les partages avec moi
...
-- Policy INSERT : Seul le propriétaire peut partager directement
-- (les collaborateurs utiliseront la fonction SQL)
...
-- ============================================
-- 4. FONCTION POUR CHARGER TOUS LES PROJETS
-- ============================================

-- Cette fonction charge les projets propres + partagés
...
-- ============================================
-- 5. FONCTION POUR PARTAGER (CONTOURNE RLS)
-- ============================================
...
-- ============================================
-- 6. FONCTION POUR RETIRER UN COLLABORATEUR
-- ============================================
...
-- ============================================
-- Maintenant :
-- 1. Les policies ne causent plus de récursion
-- 2. Utilisez get_all_user_projects() pour charger tous les projets
-- 3. Utilisez share_project_as_collaborator() pour partager
-- 4. Utilisez remove_project_share_as_collaborator() pour retirer
